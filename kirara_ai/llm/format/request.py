...
from .tool import Tool, ToolInputSchema

# 3.2.0 及更早版本中工具参数模型名为 ToolParameters，现已统一到 tool.ToolInputSchema。
# 这里保留旧名称别名，避免外部插件按旧名导入时报错。
ToolParameters = ToolInputSchema
